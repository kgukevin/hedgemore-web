  ...
  return (
    <div className="App">
      ...
      <div className="Main">
        ...
        <AboutCard layout="right" content="Over 20 years of experience in Mortgage-Backed Securities (MBS) guarantee, credit risk transfer through reinsurance, mortgage pipeline hedging, asset and liabilities management, and risk modeling for large financial instituions." header="built on extensive experience in financial insurance and reinsurance"></AboutCard>
